                ...
                <div class="text-gray-900">
                    ...
                    <div class="pt-6 border-t">
                        <div class="flex justify-between">
                            ...
                            @if(!empty($coupon))
                            <a class="text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded" href="{{ route('owner.coupons.edit',$service->id)}}">
                                編集
                            </a>
                            @else
                            <a class="text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded" href="{{ route('owner.coupons.create',$service->id)}}">
                                作成
                            </a>
                            @endif
                            {{-- <a class="text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded" href="{{ route('owner.menus.edit', [$service->id])}}">
                                編集
                            </a> --}}
                        </div>
                    </div>
