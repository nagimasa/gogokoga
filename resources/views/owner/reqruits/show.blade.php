                ...
                <div class="text-gray-900">
                    ...
                    <div class="pt-6">
                        <div class="flex justify-between">
                            ...
                            @if(!empty($reqruit))
                            <a class="text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded" href="{{ route('owner.reqruits.edit',$service->id)}}">
                                編集
                            </a>
                            @else
                            <a class="text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded" href="{{ route('owner.reqruits.create',$service->id)}}">
                                作成
                            </a>
                            @endif
                        </div>
