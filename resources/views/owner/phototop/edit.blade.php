            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="text-gray-900">
                    <div class="flex justify-between bg-blue-600 ">
                        ...
                        <div class=" pr-6 pt-6">
                            {{ Form::open(['route' => ['owner.phototop.destroy', ["phototop" => $service->id, "photo" => $photo->id]], 
                            'method'  => 'post', 'file' => true,
                            'enctype' => 'multipart/form-data',
                            'accept'  => 'iamge/png, image/jpeg, image/jpg, image/webp' ]) }}
                            @csrf
                            @method('delete')
                            {{ Form::hidden('delete_image_name', $photo->top_image_name) }}
                    ...
                    <div class="p-6">
                        ...
                        <img src="{{ asset($photo->top_image_name) }}">
                        </div>
