                ...
                <div class="text-gray-900">
                    ...
                    <div class="p-6">
                        ...
                        <div class="block py-6 border-b">
                            ...
                            {{ Form::text('password',$owner->password, ['placeholder' => 'パスワード', 'class' => 'rounded w-full md:w-1/2 ']) }}<br>
                        </div>
                        ...
                        <div class="pt-6">
                            <div class="py-2 flex justify-between">
                                ...
                                {{ Form::submit('送信', ['class' => 'btn-primary btn btn-primary text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded']) }}
                                {{ Form::close() }}
                            </div>
                        </div>
                    </div>
