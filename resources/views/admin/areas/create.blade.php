        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="text-gray-900">
                    <h2 class="text-xl bg-blue-600 text-white p-6">地域名の登録</h2>
                    ...
                    <div class="p-6">
                        ...
                        <div class="py-6">
                            ...
                            {{ Form::text('area_name', old('aera_name'), ['class' => 'w-1/2 rounded form-control ', 'id' => 'lastName', 'placeholder' => '地域名'])}}
                        </div>
                        <hr>
                        <div class="py-6">
                            {{ Form::label('area_name_kana','チイキメイ')}}<br>
                            {{ Form::text('area_name_kana', null, ['class' => 'w-1/2 rounded form-control ', 'id' => 'lastName', 'placeholder' => 'カナ名'])}}
                        </div>
                        <hr>
