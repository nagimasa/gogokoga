                    ...
                    <div class="p-6">
                        <table class="w-full">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="w-2/5 py-2"><a class="text-indigo-600 underline" href="{{ route('admin.blogs.show', $blog->id)}}">{{ $blog->blog_title }}</a></td>
                                <td class="w-2/5 py-2 text-center"><a class="text-indigo-600 underline" href="{{ route('admin.blogs.edit', $blog->id)}}">編集</a></td>
                            </tr>
                            @endforeach
                        </table>
