                ...
                <div class="text-gray-900">
                    ...
                    <table class="table table-bordered" id="dynamicAddRemove">  
                        ...
                        <tr>  
                            ...
                            <td><a href="{{ route('admin.blogs.edit', [$blog->id]) }}">編集</a></td>
                        </tr>  
                        @endforeach
                    </table> 
                    ...
                    <div class="p-6">
                        ...
                        <div class="py-6 flex justify-between">
                            ...
                            <a class="text-white bg-blue-600 border-0 py-2 px-6 mb-2 hover:bg-blue-700 rounded" href="{{ route('admin.blogs.create', [$service->id])}}">
                                追加
                            </a>
