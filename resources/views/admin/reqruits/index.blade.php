                ...
                <div class="p-6 text-gray-900">
                    ...
                    <table class="w-full">
                        ...
                        <tr class="divide-y">
                          ...
                          <td class=" text-center"><a class="text-indigo-600 underline" href="{{ route('admin.reqruits.show', $reqruit->id)}}">{{ $reqruit->reqruit_title }}</a></td>
                          <td class=" text-center"><a class="text-indigo-600 underline" href="{{ route('admin.reqruits.edit', $reqruit->id)}}">編集</a></td>
                        </tr>
                        @endforeach
                    </table>
